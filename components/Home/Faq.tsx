    ...
    const items = [
        {
            ...
            content: "Standard delivery typically takes 3-5 business days within the country. International shipping may take 7-14 business days depending on your location. Express delivery options are available at checkout for faster delivery. You'll receive a tracking number via email once your order ships.",
        },
        {
            id: "2",
        ...
        <div className="px-4 mx-auto max-w-3xl">
            ...
            <div className="mt-8 text-center">
                <p className="text-gray-600 text-sm">
                    Still have questions? Contact our customer support team at <span className="font-medium">support@sneakerstore.com</span>
                </p>
            </div>
        </div>
    );
