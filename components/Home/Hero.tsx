                        ...
                        <div className="flex flex-col md:flex-row min-h-screen">
                            ...
                            <div className="w-full md:w-1/2 flex flex-col justify-center px-8 md:px-16 lg:px-24 relative">
                                ...
                                <div className="relative z-20">
                                    <p className="font-semibold text-lg text-white">NEW IN</p>
                                    <h1 className=" text-white text-5xl md:text-6xl lg:text-7xl font-bold mb-4 tracking-tight">
                                        {sneaker.title.split("\n").map((line, index) => (
                                    ...
                                    <button className="bg-white/20 text-white font-semibold py-2 px-8 rounded-md text-lg transition-all duration-300 transform hover:scale-105">
                                        Buy Now <ArrowRight className="inline" />
                                    </button>
                                </div>

                                <div className="absolute bottom-12 left-8 md:left-16 lg:left-24 flex space-x-4">
                                    <button
                                        onClick={goPrev}
